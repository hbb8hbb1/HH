            ...
            <div className="flex-1 p-6 border-r border-gray-100 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                 <div className="space-y-1">
                    ...
                    <input type="text" value={company} onChange={e => setCompany(e.target.value)} className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-100 focus:outline-none" placeholder="如: Google" />
                 </div>
                 <div className="space-y-1">
                    <label className="text-[10px] font-bold text-gray-400 uppercase">职位</label>
                    <input type="text" value={role} onChange={e => setRole(e.target.value)} className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-100 focus:outline-none" placeholder="如: 前端工程师" />
                 </div>
                 <div className="space-y-1">
                 ...
                 <div className="space-y-1">
                    ...
                    <input type="text" value={tagInput} onKeyDown={addTag} onChange={e => setTagInput(e.target.value)} className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-100 focus:outline-none" placeholder="回车添加" />
                 </div>
              </div>
